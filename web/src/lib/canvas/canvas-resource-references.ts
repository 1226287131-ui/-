...
export function getMentionResourceNodes(nodeId: string, nodes: CanvasNodeData[], connections: CanvasConnection[]) {
    ...
    const inheritedInputs = expandGroupResourceNodes(getUpstreamConfigResourceNodes(nodeId, nodes, connections), nodes);
...
function getUpstreamConfigResourceNodes(nodeId: string, nodes: CanvasNodeData[], connections: CanvasConnection[]) {
    ...
    return upstreamConfig ? getContextInputNodes(upstreamConfig.id, nodes, connections) : [];
}
