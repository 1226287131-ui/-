export default {
    ...
    canvas: {
        ...
        projectPage: {
            videoNodeCreated: "复制为新视频节点（已保留参考素材顺序和提示词）",
        ...
        promptPanel: { video: "描述要生成的视频内容", audio: "描述要生成的音频内容", image: "描述要生成的图片内容", text: "请输入你想要生成的文本内容", editImage: "请输入你想要把这张图修改成什么", editText: "请输入你想要将本段文本修改成什么", expandEditor: "放大编辑", editorTitle: "编辑提示词", copyVideoNode: "复制为新视频节点", stopGeneration: "停止生成", generate: "生成", stop: "停止" },
