export default {
    ...
    settingsPanels: {
        ...
        video: { title: "视频设置", quality: "清晰度", size: "尺寸", seconds: "秒数", resolution: "分辨率", ratio: "比例", duration: "时长", smart: "智能", output: "输出", generateAudio: "生成声音", watermark: "添加水印", adaptive: "自适应", workflow: "工作流", workflowSize: "超分尺寸", workflowHint: "自动模式会按参考素材选择 text-to-video 或 multi-reference。", workflowSizeHint: "cf 工作流必须选择 2K 或 4K。", multiReferenceResolution: "多参考图仅支持 480p 或 720p。", workflows: { auto: "自动（按参考素材）", "text-to-video": "文生视频（text-to-video）", "multi-reference": "多参考（multi-reference）", fl2v: "首尾帧（fl2v）", "cf-multi-reference": "超分多参考（cf-multi-reference）", "cf-fl2v": "超分首尾帧（cf-fl2v）", mj: "MJ（mj）", "cf-mj": "超分 MJ（cf-mj）" }, sizes: { landscape: "横屏", portrait: "竖屏", square: "方形", widescreen: "宽屏", tall: "长图", auto: "自动" }, ratios: { landscape: "横屏", portrait: "竖屏", square: "方形", standardLandscape: "标准横屏", standardPortrait: "标准竖屏", cinematic: "宽银幕", adaptive: "自适应" } },
    ...
    canvas: {
        ...
        promptPanel: { video: "描述要生成的视频内容", audio: "描述要生成的音频内容", image: "描述要生成的图片内容", text: "请输入你想要生成的文本内容", editImage: "请输入你想要把这张图修改成什么", editText: "请输入你想要将本段文本修改成什么", expandEditor: "放大编辑", editorTitle: "编辑提示词", copyImageNode: "复制为新图片节点", copyVideoNode: "复制为新视频节点", stopGeneration: "停止生成", generate: "生成", stop: "停止" },
