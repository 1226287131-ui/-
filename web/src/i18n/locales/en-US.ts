export default {
    ...
    settingsPanels: {
        ...
        video: { title: "Video settings", quality: "Quality", size: "Size", seconds: "Seconds", mode: "Mode", modes: { frames: "First & last frame", reference: "General reference" }, resolution: "Resolution", ratio: "Aspect ratio", duration: "Duration", smart: "Smart", output: "Output", generateAudio: "Generate audio", watermark: "Add watermark", adaptive: "Adaptive", workflow: "Workflow", workflowSize: "Super-resolution size", workflowHint: "Auto selects text-to-video or multi-reference from the reference media.", workflowSizeHint: "cf workflows require 2K or 4K.", multiReferenceResolution: "Multiple reference images support 480p or 720p only.", workflows: { auto: "Auto (from references)", "text-to-video": "Text to video (text-to-video)", "multi-reference": "Multi-reference (multi-reference)", fl2v: "First/last frame (fl2v)", "cf-multi-reference": "Super-resolution multi-reference (cf-multi-reference)", "cf-fl2v": "Super-resolution first/last frame (cf-fl2v)", mj: "MJ (mj)", "cf-mj": "Super-resolution MJ (cf-mj)" }, sizes: { landscape: "Landscape", portrait: "Portrait", square: "Square", widescreen: "Widescreen", tall: "Tall", auto: "Auto" }, ratios: { landscape: "Landscape", portrait: "Portrait", square: "Square", standardLandscape: "Standard landscape", standardPortrait: "Standard portrait", cinematic: "Cinematic", adaptive: "Adaptive" } },
    ...
    canvas: {
        ...
        projectPage: {
            videoNodeCreated: "Copied as a new video node with the same reference order and prompt", imageNodeCreated: "Copied as a new image node with the same references and prompt", batchConnected: "Connected {{count}} media nodes",
