export default {
    ...
    settingsPanels: {
        ...
        video: { title: "Video settings", quality: "Quality", size: "Size", seconds: "Seconds", resolution: "Resolution", ratio: "Aspect ratio", duration: "Duration", smart: "Smart", output: "Output", generateAudio: "Generate audio", watermark: "Add watermark", adaptive: "Adaptive", workflow: "Workflow", workflowSize: "Super-resolution size", workflowHint: "Auto selects text-to-video or multi-reference from the reference media.", workflowSizeHint: "cf workflows require 2K or 4K.", multiReferenceResolution: "Multiple reference images support 480p or 720p only.", workflows: { auto: "Auto (from references)", "text-to-video": "Text to video (text-to-video)", "multi-reference": "Multi-reference (multi-reference)", fl2v: "First/last frame (fl2v)", "cf-multi-reference": "Super-resolution multi-reference (cf-multi-reference)", "cf-fl2v": "Super-resolution first/last frame (cf-fl2v)", mj: "MJ (mj)", "cf-mj": "Super-resolution MJ (cf-mj)" }, sizes: { landscape: "Landscape", portrait: "Portrait", square: "Square", widescreen: "Widescreen", tall: "Tall", auto: "Auto" }, ratios: { landscape: "Landscape", portrait: "Portrait", square: "Square", standardLandscape: "Standard landscape", standardPortrait: "Standard portrait", cinematic: "Cinematic", adaptive: "Adaptive" } },
    ...
    videoWorkbench: {
        ...
        noAudio: "No reference audio. Drag in up to 3 audio files, each under 64 MiB.",
        ...
        audioTooLarge: "Reference audio over 64 MiB was ignored",
    ...
    config: {
        ...
        channelEditor: {
            ...
            empty: "Select models fetched from the current API.",
            capabilities: {
                image: "Image",
                video: "Video",
                text: "Text",
        ...
        modelSelect: {
            ...
            description: "Models come from the current provider API and only models returned by it are shown.",
            ...
            fetchedEmpty: "Fetch models from the provider.",
